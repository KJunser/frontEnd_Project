(function() {
    ...
    function initHeader() {
        ...
        var canvases = document.querySelectorAll('.constellation');

        canvases.forEach(function(canvasElement) {
            ...
            for(var i in points) {
                var c = new Circle(ctx, points[i], 2+Math.random()*2, 'rgba(255,255,255,0.3)');
                points[i].circle = c;
            }
    ...
    function resize() {
        width = window.innerWidth;
        height = window.innerHeight;
        canvasInstances.forEach(function(inst) {
