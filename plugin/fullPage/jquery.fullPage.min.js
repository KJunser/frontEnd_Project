 ...
 */
(function(c,k,g,l,D){c.fn.fullpage=function(d){function Aa(a){a.find(".fp-slides").after('<div class="fp-controlArrow fp-prev"><i class="bi bi-chevron-left"></i></div><div class="fp-controlArrow fp-next"><i class="bi bi-chevron-right"></i></div>');"#fff"!=d.controlArrowColor&&(a.find(".fp-controlArrow.fp-next").css("border-color","transparent transparent transparent "+d.controlArrowColor),a.find(".fp-controlArrow.fp-prev").css("border-color","transparent "+d.controlArrowColor+" transparent transparent"));d.loopHorizontal||a.find(".fp-controlArrow.fp-prev").hide()}
